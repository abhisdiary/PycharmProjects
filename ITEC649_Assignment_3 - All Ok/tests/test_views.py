...
class FunctionalTests(unittest.TestCase):
    ...
    def test_home_page_links(self):  # passed
    ...
    def test_home_page_product_names(self):  # passed
    ...
    def test_home_page_product_links(self):  # passed
    ...
    def test_home_page_creates_cookie(self):  # passed
    ...
    def test_product_page_creates_cookie_with_path(self):  # passed
    ...
    def test_category_page_product_names(self):  # passed
    ...
    def test_category_page_bad_category(self):  # passed
    ...
    def test_product_page(self):  # passed
    ...
    def test_product_page_not_found(self):  # passed
    ...
    def test_product_page_add_cart_form(self):
        ...
        for key in self.products:
            ...
            self.assertEqual(str(product['id']), cartform['product'].value)  # Here is the problem......What is happening here?
