...
if len(known_plaintext) > max_key_length:
    print("The length of the known plaintext is greater than max_key_length (=" + str(
        max_key_length) + "). Please give a smaller plaintext or increase max_key_length.")
    exit()
...
print("Searching XOR-encrypted " + filename + " for string '" + known_plaintext + "' (max_key_length = " + str(
    max_key_length - 1) + ")")
